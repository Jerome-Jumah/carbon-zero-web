function PrivacyPage() {
  return (
    <div className="container font-quicksand">
      <p> Jerome Jumah built the CarbonZero app as a Free app. This SERVICE is provided by Jerome Jumah at no cost and is intended for use as is. </p>
      <p>
        {" "}
        This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided
        to use my Service.{" "}
      </p>
      <p>
        {" "}
        ...
        that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in
        this Privacy Policy.{" "}
      </p>
      <p>
        {" "}
        The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at CarbonZero unless
      ...
      <p>
        ...
        but not limited to First Name, Last Name, country, house hold energy consumption, diet. The information that I request will be retained on
      ...
      <ul className="text-primary mb-2">
      ...
      <p>
        ...
        sites are not operated by me. Therefore, I strongly advise you to review the Privacy Policy of these websites. I have no control over and
      ...
      <p>
        ...
        <span className="text-primary">
          {" "}
          <a href="mailto:jeromejuma25@gmail.com">jeromejuma25@gmail.com</a>
        </span>
        .
      </p>
    </div>
